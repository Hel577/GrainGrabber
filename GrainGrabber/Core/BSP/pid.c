...
PIDController *rough_Z_super_long_PID = NULL;
...
void Init_PID(void)
{
    ...
    rough_Z_super_long_PID = (PIDController *)malloc(sizeof(PIDController));
    ...
    {
        rough_X_super_long_PID->kp = 6.9f;
        ...
        rough_X_super_long_PID->max_output = 1800.0f;
        rough_X_super_long_PID->max_accel = 1800.0f;
    ...
    {
        rough_Y_super_long_PID->kp = 5.6f;
        ...
        rough_Y_super_long_PID->max_output = 1800.0f;
        rough_Y_super_long_PID->max_accel = 1800.0f;
    ...
    {
        rough_Z_super_long_PID->kp =3.3f;
        rough_Z_super_long_PID->ki = 0.001f;
        rough_Z_super_long_PID->kd = 1.2f;
        rough_Z_super_long_PID->dt = 0.018f;
        rough_Z_super_long_PID->integral = 0.0f;
        rough_Z_super_long_PID->prev_error = 0.0f;
        rough_Z_super_long_PID->max_output = 200.0f;
        rough_Z_super_long_PID->max_accel = 220.0f;
        rough_Z_super_long_PID->last_call_time = HAL_GetTick();
        memset(rough_Z_super_long_PID->deriv_buf, 0, sizeof(rough_Z_super_long_PID->deriv_buf));
        rough_Z_super_long_PID->last_output = 0.0f;
        rough_Z_super_long_PID->prev_filtered = 0.0f;
        rough_Z_super_long_PID->prev_position = 0.0f;
        rough_Z_super_long_PID->first_call = true;
    }
